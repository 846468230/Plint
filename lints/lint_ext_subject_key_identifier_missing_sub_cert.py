...
'''
class subjectKeyIdMissingSubscriber(base.LintInterface):
...
def init():
    base.RegisterLint(base.Lint("w_ext_subject_key_identifier_missing_sub_cert","Sub certificates SHOULD include Subject Key Identifier in end entity certs","RFC 5280: 4.2 & 4.2.1.2",base.LintSource.RFC5280,Time.RFC2459Date,subjectKeyIdMissingSubscriber()))