...
Restrictions are defined in terms of permitted or excluded name
   ...
   be present.
'''
class nameConstraintInvalid(base.LintInterface):
    ...
    def Execute(self,c):
        try:
            ...
            if "The <ObjectIdentifier(oid=2.5.29.30, name=nameConstraints)> extension is invalid and can't be parsed"==str(e):
                return base.LintResult(base.LintStatus.Error)
            return base.LintResult(base.LintStatus.Fatal)
def init():
    base.RegisterLint(base.Lint("e_name_constraint_Invalid","Conforming CAs MUST NOT issue certificates where name constraints is an empty sequence. That is, either the permittedSubtree or excludedSubtree fields must be present","RFC 5280: 4.2.1.10",base.LintSource.RFC5280,Time.RFC2459Date,nameConstraintInvalid()))