...
'''
class rsaParsedTestsKeyModOdd(base.LintInterface):
...
def init():
    base.RegisterLint(base.Lint("w_rsa_mod_not_odd","RSA: Modulus SHOULD also have the following characteristics: an odd number","BRs: 6.1.6",base.LintSource.CABFBaselineRequirements,Time.CABV113Date,rsaParsedTestsKeyModOdd()))